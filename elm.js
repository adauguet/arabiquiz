...
var author$project$Digit$Eight = {$: 'Eight'};
var author$project$Digit$Five = {$: 'Five'};
var author$project$Digit$Four = {$: 'Four'};
var author$project$Digit$Nine = {$: 'Nine'};
var author$project$Digit$One = {$: 'One'};
var author$project$Digit$Seven = {$: 'Seven'};
var author$project$Digit$Six = {$: 'Six'};
var author$project$Digit$Three = {$: 'Three'};
var author$project$Digit$Two = {$: 'Two'};
var author$project$Digit$Zero = {$: 'Zero'};
...
var author$project$Digit$generate = function (m) {
	return A2(
		elm$random$Random$generate,
		m,
		A2(
			elm$random$Random$uniform,
			author$project$Digit$Zero,
			_List_fromArray(
				[author$project$Digit$One, author$project$Digit$Two, author$project$Digit$Three, author$project$Digit$Four, author$project$Digit$Five, author$project$Digit$Six, author$project$Digit$Seven, author$project$Digit$Eight, author$project$Digit$Nine])));
};
var author$project$Main$GotRandomDigit = function (a) {
	return {$: 'GotRandomDigit', a: a};
};
var author$project$Main$Loading = {$: 'Loading'};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$Loading,
		author$project$Digit$generate(author$project$Main$GotRandomDigit));
};
var author$project$Digit$fromChar = function (c) {
	switch (c.valueOf()) {
		case '1':
			return elm$core$Maybe$Just(author$project$Digit$One);
		case '2':
			return elm$core$Maybe$Just(author$project$Digit$Two);
		case '3':
			return elm$core$Maybe$Just(author$project$Digit$Three);
		case '4':
			return elm$core$Maybe$Just(author$project$Digit$Four);
		case '5':
			return elm$core$Maybe$Just(author$project$Digit$Five);
		case '6':
			return elm$core$Maybe$Just(author$project$Digit$Six);
		case '7':
			return elm$core$Maybe$Just(author$project$Digit$Seven);
		case '8':
			return elm$core$Maybe$Just(author$project$Digit$Eight);
		case '9':
			return elm$core$Maybe$Just(author$project$Digit$Nine);
		case '0':
			return elm$core$Maybe$Just(author$project$Digit$Zero);
		default:
			return elm$core$Maybe$Nothing;
	}
};
var author$project$Main$OnDigitPressed = function (a) {
	return {$: 'OnDigitPressed', a: a};
};
...
var author$project$Main$keyDecoder = A2(
	...
	function (string) {
		...
		if ((_n0.$ === 'Just') && (_n0.a.b === '')) {
			var _n1 = _n0.a;
			var _char = _n1.a;
			var _n2 = author$project$Digit$fromChar(_char);
			if (_n2.$ === 'Just') {
				var digit = _n2.a;
				return elm$json$Json$Decode$succeed(
					author$project$Main$OnDigitPressed(digit));
			} else {
				return elm$json$Json$Decode$fail('failed to decode digit');
			}
		} else {
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		if (msg.$ === 'GotRandomDigit') {
			var digit = msg.a;
			return _Utils_Tuple2(
				author$project$Main$Question(digit),
			...
			if (model.$ === 'Loading') {
				...
				var d = model.a;
				return _Utils_eq(d, digit) ? _Utils_Tuple2(
					author$project$Main$Loading,
					author$project$Digit$generate(author$project$Main$GotRandomDigit)) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$Digit$toArabic = function (d) {
	switch (d.$) {
		case 'Zero':
			return '٠';
		case 'One':
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Digit$toArabic(digit))
							]))
					]))
			]);
	}
